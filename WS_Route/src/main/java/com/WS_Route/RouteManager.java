...
public class RouteManager {
	...
	public RouteManager(String user, String securityContext, String inputFile, String logFile) throws Exception {
		try {
	...
	public Response CreateRoute() throws FileNotFoundException,
		            ...
		            JSONObject obj = (JSONObject) o;		            
		    				...
		    				obj.toString());
		    				 ...
		    				 if (code == 200) {		    					 
		    					 ...
		    					 genlog = new genLog(HostName, step, "Import KO", type, "-", "-", code, Body.toString(),"-",logFile);
		    				 }
